...
const Features = () => {
  return (
    <FeaturesCont id="features">
      <h1 data-aos="zoom-in">
        Why <span className="waivy">Adacubator</span> ?
      </h1>
      <div className="container">
        <Card
          ...
          icon={support}
          text="We provide the financial backing needed to take your project from concept to reality, helping you overcome any financial barriers to entry"
        />
        <Card
          dataAos="fade-up"
          title="Ecosystem Growth"
          icon={growth}
          text="By focusing exclusively on the Cardano blockchain, we aim to cultivate a thriving ecosystem of innovative solutions and applications."
        />
        <Card
          dataAos="fade-left"

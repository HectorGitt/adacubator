	...
	return (
		<BannerCont id="pitch">
			<div>
				...
				<p data-aos="fade-up">
					If you&lsquo;re building a project on Cardano and believe in
					making a difference, AdaCubator is your ideal partner.
					Together, we can push the boundaries of what&lsquo;s
					possible and shape the future of blockchain technology.
				</p>
				<Button
					dataAos="fade-up"
					text="Pitch To Us"
